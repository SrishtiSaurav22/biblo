...
```
## 3. Update ```main.py```
Replace original content with the following:
```
...
```
d. You can test everything from the browser.
<img src="assets/image_6.png" width="1200">
<img src="assets/image_7.png" width="1200">
